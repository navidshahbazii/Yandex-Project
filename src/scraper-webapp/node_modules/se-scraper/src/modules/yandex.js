...
class YandexScraper extends Scraper {
	...
	if (this.config.yandex_settings) {
            startUrl = `https://www.${this.config.yandex_settings.yandex_domain}`;
            if (this.config.yandex_settings.yandex_domain) {
                startUrl = `https://www.${this.config.yandex_settings.yandex_domain}`;
            } else {
                startUrl = `https://www.yandex.com`;
            }
